    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("Button", "username :" +username);
                Log.i("Button", "email :" +email);
                Log.i("Button", "password :" +password);
                Log.i("Button", "confirm password :" +confirm);

                Database db = new Database(getApplicationContext(),"healthcare.db",null,1);
